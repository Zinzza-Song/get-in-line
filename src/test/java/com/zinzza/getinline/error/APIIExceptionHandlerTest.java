...
class APIIExceptionHandlerTest {

    private APIIExceptionHandler sut;
    private WebRequest webRequest;

    @BeforeEach
    void setUp() {
        sut = new APIIExceptionHandler();
    ...
    void givenValidationException_whenCallingValidation_thenReturnsResponseEntity() {
        ...
        //then
        assertThat(response)
                .hasFieldOrPropertyWithValue("body", APIErrorResponse.of(false,
    ...
    @DisplayName("기타 일반 오류 - 응답 데이터 정의")
    @Test
