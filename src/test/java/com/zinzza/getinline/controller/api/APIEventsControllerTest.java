...
class APIEventsControllerTest {
    ...
    void givenWrongParams_whenRequestingEvents_thenReturnsFailedInStandardResponse() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$.message").value(Matchers.containsString(ErrorCode.VALIDATION_ERROR.getMessage())));
    ...
    void givenWrongEvent_whenCreatingAnEvent_thenReturnsFailedStandardResponse() throws Exception {
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$.message").value(Matchers.containsString(ErrorCode.SPRING_BAD_REQUEST.getMessage())));
        then(eventService).shouldHaveNoInteractions();
    }
